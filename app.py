...
with st.sidebar:
    ...
    resume_text = st.text_area("Paste your resume / profile text", height=170,
...
if go:
    ...
    tab1, tab2, tab3 = st.tabs(["🏆 Top Job Matches", "🎯 Skill Gap", "🗺️ Learning Roadmap"])
    ...
    with tab3:
        ...
        if roadmap:
            ...
            st.balloons()
            st.success("No gaps — you're already job-ready for this role!")
else:
